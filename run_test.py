...
def run_tests():
    ...
    df = rf.load_data_from_csv(sample_size=0.1)  # Use 10% of data for faster testing
    ...
    with open('testresult.txt', 'w') as f:
        ...
        f.write(f"- Products: {len(df['Product'].unique())}\n\n")
        ...
        f.write("\n## Conclusion\n")
        f.write("The Random Forest model provides accurate demand predictions based on historical sales data. ")
        f.write("The model takes into account various factors including price, promotions, seasonality, and external events. ")
        f.write("The demand forecast can help optimize inventory management and reduce stockouts and overstock situations.\n")
